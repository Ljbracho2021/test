...
class BecaPlanilla(models.Model):
    ...
    anoegreso = fields.Selection([
        ...
        ('23', '2021'),
        ('24', '2022'),
    ], string='Año Egreso Bachilerato *', default = '22', required = True, help="Seleccione el Año de Egres de Bachillerato (es campo Obligatorio).")
    ...
    anulada_id = fields.Selection([
        ...
        ('3', 'CON TACHADURAS'),
        ('4', 'OTRO'),
    ], required=True, string='Motivo Anulaciòn *', help="Seleccione el Motivo de Anulaciòn de la Planilla (es campo Obligatorio).")
    ...
    def _onchange_cedula(self):
        ...
        if aux_int > 99999999:
            ...
            return {'warning': {
                'title': ("Mensaje de Error:"), 
                'message': ("Error: EL NÚMERO DE CÉDULA debe estar entre 10.000.000 y 99.999.999"), 
            }}
