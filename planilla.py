...
class BecaPlanilla(models.Model):
    ...
    modalidad = fields.Selection([
        ('0', 'UNIVERSIDAD'),
        ('1', 'CURSO'),
    ], required=True, string='Opciones de Estudio (*)', help="Seleccione la Modalidad de Estudios (es campo Obligatorio).")
    ...
    anoegreso1 = fields.Selection([
        ...
        ('23', '2021'),
        ('24', '2022'),
    ], string='Año Egreso Bachiller (*)', default = '22', required = True, help="Seleccione el Año de Egres de Bachillerato (es campo Obligatorio).")
    ...
    def create(self, vals):
        ...
        if not self.anoegreso:
           return {'warning': {
                'title': ("Precauciòn:"), 
                'message': ("Error: El Año de Egreso de Bachiller vacio (es Campo Obligatorio) "),  
           }}
