...
class WizardAnularn(models.TransientModel):
    ...
    def action_anular(self):
        ...
        muni     = self.env['beca.municipio'].search([],limit=1)
        parro    = self.env['beca.parroquia'].search([],limit=1)
        carre    = self.env['beca.carrera'].search([],limit=1)
